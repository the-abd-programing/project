...
function xzcard2(){
    ...
    const select = [0,1,2,3,4,5,6]
    return(
        
        <div className="deliver-card2">
            <Xzcards2>
            <Link to={'/Cards2/'}>
        <img src="https://thumbs.dreamstime.com/b/fast-food-concept-greasy-fried-restaurant-take-out-as-onion-rings-burger-hot-dogs-fried-chicken-french-fries-31114163.jpg" alt="" id="deliver-img-2"/>        
    </Link>
...
<select name="" id="cardxzseleckt2" value={select}>
{select.map(d =>
